            ...
            <div className="mx-auto px-8 flex flex-col items-center">
                <div className="flex items-center justify-start">
                    ...
                    <div className="ml-3">
                        ...
                        <p className="text-xs lg:text-sm text-gray-500">All your account data in one place: advanced statistics powered by the <a href="https://mercurydata.app/">Mercury indexer</a> coming soon.</p>
                    </div>
                </div>
            </div>
        </div>
