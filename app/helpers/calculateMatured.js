...
export default function CalculateMatured(publicKey, allEvents, id, ContractAccountYieldNodes) {
    const toHex = (b64) => {
    ...
    const to_mature = stroopsToXLM(getTotYield(id, YieldAccountData, 16), 4) - float_tot_collected;
