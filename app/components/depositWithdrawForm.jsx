...
export const WithrawOrDeposit = (params) => {
  ...
  return (
    <div>
      ...
      <div className="mt-8 mb-10">
        {showForm1 && (
          <div>
          <Deposit contractId={params.contractId} publicKey={params.publicKey} />
          </div>
        )}

        {!showForm1 && (
          <Withdraw contractId={params.contractId} publicKey={params.publicKey} />
        )}
      </div>
    </div>
  );}
