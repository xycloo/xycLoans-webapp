...
export const YieldChart = (params) => {
    ...
    const yields = params.data.length === 1 ? [parseFloat(stroopsToXLM(parseBase64Yield(params.data[0].yield, 8), 3))] : params.data.map(entry => parseFloat(stroopsToXLM(parseBase64Yield(entry.yield, 8), 3)))
